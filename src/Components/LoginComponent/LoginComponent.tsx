  ...
  return (
    <div className="min-h-screen relative overflow-hidden bg-gradient-to-br from-gray-900 via-purple-900 to-indigo-900">
      ...
      <div className="absolute inset-0">
        ...
        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-[800px] h-[800px] bg-gradient-to-r from-purple-500/5 to-pink-500/5 rounded-full blur-3xl animate-pulse" style={{ animationDelay: '2s' }}></div>
      </div>
      ...
      <div className="relative z-10 min-h-screen flex flex-col items-center justify-center p-8">
        ...
        {/* Welcome Text */}
        <div className="text-center mb-12 animate-in fade-in-0 slide-in-from-top-2 duration-500" style={{ animationDelay: '200ms', animationFillMode: 'both' }}>
          ...
          <p className="text-xl text-gray-300 max-w-2xl mx-auto">
            Sign in to your account to access your favorite movies and personalized recommendations
          </p>
        </div>

        {/* Login Card */}
        <div className="w-full max-w-md animate-in fade-in-0 slide-in-from-bottom-4 duration-500" style={{ animationDelay: '400ms', animationFillMode: 'both' }}>
          <Card
            className="bg-gray-800/50 backdrop-blur-xl border border-purple-500/20 shadow-2xl shadow-purple-900/20"
            title={
          ...
          >
            ...
            >
              <div className="space-y-5">
                <div className="animate-in fade-in-0 slide-in-from-left-2 duration-300" style={{ animationDelay: '600ms', animationFillMode: 'both' }}>
                  <Input
                    label={
                ...
                <div className="animate-in fade-in-0 slide-in-from-right-2 duration-300" style={{ animationDelay: '700ms', animationFillMode: 'both' }}>
                  <Input
                    label={
                      <span className="text-gray-300 font-medium flex items-center gap-2">
                        <svg className="w-4 h-4 text-purple-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <div className="animate-in fade-in-0 slide-in-from-bottom-2 duration-300" style={{ animationDelay: '800ms', animationFillMode: 'both' }}>
                <Button
                  type="submit"
                  variant="primary"
                  size="lg"
              ...
              <div className="text-center animate-in fade-in-0 slide-in-from-bottom-1 duration-300" style={{ animationDelay: '900ms', animationFillMode: 'both' }}>
        ...
        {/* Footer */}
        <div className="absolute bottom-8 left-1/2 transform -translate-x-1/2 animate-in fade-in-0 slide-in-from-bottom-2 duration-500" style={{ animationDelay: '1000ms', animationFillMode: 'both' }}>
